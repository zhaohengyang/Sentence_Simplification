...
# embedding_attention_seq2seq(encoder_inputs, decoder_inputs, cell,
#                                 num_encoder_symbols, num_decoder_symbols,
#                                 embedding_size,
#                                 num_heads=1, output_projection=None,
#                                 feed_previous=False, dtype=dtypes.float32,
#                                 scope=None, initial_state_attention=False)
# sampled_softmax_loss(weights, biases, inputs, labels, num_sampled,
...
class Seq2SeqModel(object):
  ...
  def step(self, session, encoder_inputs, decoder_inputs, target_weights,
    ...
    """Run a   of the model feeding the given inputs.
...
#     num_samples = 12
#
#     model = Seq2SeqModel(source_vocab_size, target_vocab_size, buckets, size,
#                num_layers, max_gradient_norm, batch_size, learning_rate,
#                learning_rate_decay_factor, use_lstm=False,
#                num_samples=512, forward_only=False)
